...
<ArticleImage
  ...
  caption={
    <>
      Making something work on a customer's site, whose shape is hard to
      predict, is like developing a sticky note that sticks anywhere. Photo:{" "}
...
> this is intended, you can use the /_ @vite-ignore _/ comment to suppress this
> warning.
...
- [Vercel Live Feedback script (minified)](https://vercel.live/_next-live/feedback/feedback.js)
...
- [Demo main.js (minified)](https://mini-multi-scripts-live-locator.vercel.app/main.js)
- [Demo live-locator.js (minified)](https://mini-multi-scripts-live-locator.vercel.app/live-locator/live-locator.js)
