...
- ChatGPT와의 수많은 대화...
- [_알파카 [AWS] EC2 인스턴스 위에 Redash 설치하기](https://yeonnys.tistory.com/entry/AWS-EC2-%EC%9D%B8%EC%8A%A4%ED%84%B4%EC%8A%A4-%EC%9C%84%EC%97%90-Redash-%EC%84%A4%EC%B9%98%ED%95%98%EA%B8%B0)
- [Setting up HTTPS with LetsEncrypt for Redash Docker Deployment](https://gist.github.com/arikfr/64c9ff8d2f2b703d4e44fe9e45a7730e)
