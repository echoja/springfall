...
<div className="flex flex-col max-w-lg mx-auto gap-2">
  <div className="px-6  flex justify-between bg-gray-50 dark:bg-gray-600 rounded-md  ">
    <div className="text-sm font-bold text-gray-400">
      제목, 생성일, 수정일 등등
    </div>
  </div>
  <div className="p-6  bg-gray-50 dark:bg-gray-600  rounded-md">
    <div className="text-sm font-bold mb-4 text-gray-400">콘텐츠</div>
    <div className="flex flex-col gap-5">
      <div className="w-full h-14 bg-slate-200 dark:bg-slate-700 rounded shadow flex justify-center items-center">
        일반 문단
      </div>
      <div className="w-full h-20 bg-yellow-200 dark:bg-yellow-700 rounded shadow flex justify-center items-center">
        이미지
      </div>
      <div className="w-full h-20 bg-blue-200 dark:bg-blue-700 rounded shadow flex justify-center items-center">
        인용구
      </div>
      <div className="w-full h-32 bg-slate-200 dark:bg-slate-700 rounded shadow flex justify-center items-center">
        일반 문단
      </div>
      <div className="w-full h-20 bg-yellow-200 dark:bg-yellow-700 rounded shadow flex justify-center items-center">
        이미지
