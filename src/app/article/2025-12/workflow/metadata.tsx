...
const slug = "article/2025-12/workflow";
export const summary =
  "일련의 작업들이 모두 다 잘 진행되어야 비로소 성공하는, 하지만 각 단계에서 실패를 적절히 처리해야 하는 워크플로우 시스템을 간단히 만들어봅시다";

export const createdAt = dayjs("2025-12-18").toISOString();
export const updatedAt = dayjs("2025-12-18").toISOString();
export const image = i1;
export const imageAlt = "Workflow Illustration";
